...
const { getInformixConnection, prepare, wrapTransaction } = require('../common/informix_ifxnjs')
// const {
//   createPool,
...
console.log("--------------- Executing fun migrateifxupdatedata --------------------");
console.log(payload);
console.log("work1---------------------------------------")
console.log(payload)
const columns = payload.DATA
...
module.exports = {migrateifxinsertdata,

...
async function migratepgInsert(dbpool, payload) {
  try {
    ...
    console.log(`end connection of postgres for database after insert`);
  } catch (e) {
    throw e;
  }
}
...
async function migratepgUpdate(dbpool, payload) {
  try {
    ...
    console.log(`end connection of postgres for database after update`);
  } catch (e) {
    throw e;
  }
}
...
async function migratepgDelete(dbpool, payload) {
  try {
    ...
    console.log(sql);
    await client.query(sql);
    console.log(`end connection of postgres for database after delete`);
  } catch (e) {
    throw e;
  }
